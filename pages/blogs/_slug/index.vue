<template>
    <div class="BlogsDetails">
        <div class="enBlogsDetails mont" v-if="language == 'en'">
            <Header lang="eng" @change="change" />
            <div class="topDiv">
                <h3>Blog</h3>
                <h1>Every Things About Aluminium.</h1>
                <p>Articles and research in the field of aluminum industry</p>
            </div>
            <div class="lineDiv">
                <Lines myVw="1920" myVh="360" />
            </div>
            <div class="blogList">
                <div class="d-flex justify-content-between blog">
                    <img
        ...
        <div class="faBlogsDetails irancell" v-else>
            <Header lang="fa" @change="change" />
            <div class="topDiv">
                <h3 class="mont">Blog</h3>
                <h1>همه چیز درباره ی آلومینیوم</h1>
                <p>مقالات و تحقیقات در زمینه صنعت آلومینیوم</p>
            </div>
