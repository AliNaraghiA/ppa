<template>
    <div class="header">
        <div
            v-if="lang == 'eng'"
            class="enHeader d-flex justify-content-between">
            <img
                src="/icons/bars.svg"
                @click="showMenu"
                class="barsIcon"
            ...
            <div class="d-flex">
                <div class="d-flex links">
                    ...
                    <div class="productsLinks">
                        ...
                        <router-link to="/enIndustrial" class="underLink">
                            Industrial
                        </router-link>
                        <router-link to="/enConstruction" class="underLink">
                            Construction
                        </router-link>
                        <router-link to="/enExclusive" class="underLink">
                            Exclusive
                        </router-link>
                    </div>
...
export default {
    ...
    methods: {
        change() {
            if (this.$route.path == "/units") {
                ...
                this.$emit("change");
            } else if (this.$route.path == "/enIndustrial") {
                this.$router.push("industrial");
                this.$emit("change");
            } else if (this.$route.path == "/industrial") {
                this.$router.push("enIndustrial");
                this.$emit("change");
            } else if (this.$route.path == "/enExclusive") {
                this.$router.push("exclusive");
                this.$emit("change");
            } else if (this.$route.path == "/exclusive") {
                this.$router.push("enExclusive");
                this.$emit("change");
            } else if (this.$route.path == "/enConstruction") {
                this.$router.push("construction");
                this.$emit("change");
            } else if (this.$route.path == "/construction") {
                this.$router.push("enConstruction");
                this.$emit("change");
            } else {
                this.$emit("change");
            }
        ...
        handleScroll() {
            if (window.scrollY == 0) {
                if (window.innerWidth > 750) {
                    ...
                    document
                        .getElementsByClassName("header")[0]
                        .getElementsByClassName("whiteLogo")[0].style.width =
                        "100px";
                    document
                        .getElementsByClassName("header")[0]
                        .getElementsByClassName("whiteLogo")[0].style.height =
                        "87px";
                } else {
                    document.getElementsByClassName(
                        "header"
    ...
    mounted() {
        ...
        if (this.$route.path == "/" || this.$route.path == "/enHome") {
            ...
            this.$route.path == "/exclusive" ||
            this.$route.path == "/enExclusive"
        ) {
            this.page = 3;
        } else if (
            this.$route.path == "/industrial" ||
            this.$route.path == "/enIndustrial"
        ) {
            this.page = 3;
        } else if (
            this.$route.path == "/construction" ||
            this.$route.path == "/enConstruction"
        ) {
            this.page = 3;
        } else if (
            this.$route.path == "/units" ||
            this.$route.path == "/enUnits"
        ) {
            this.page = 4;
        } else if (
            this.$route.path == "/media" ||
            this.$route.path == "/enMedia"
        ) {
            this.page = 5;
        } else if (
            this.$route.path == "/blogs" ||
            this.$route.path == "/enBlogs"
        ) {
            this.page = 6;
        } else if (
            this.$route.path == "/contactUs" ||
            this.$route.path == "/enContactUs"
        ) {
            this.page = 7;
        }
